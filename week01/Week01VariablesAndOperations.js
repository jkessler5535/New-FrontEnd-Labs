...
var streetAddress = " 719 Jasmine st. Victorville Ca ";
...
console.log("Seasons changed, its now not cold...isHotOutside = " + isHotOutside)
...
//  ↓ YOUR CODE HERE ↓
console.log("Here is a new customer! His name is :" + fullName + "." + "They live at" + streetAddress)
